        ...
        <div class="header-grid">
            <div class="popup-wrap noti type-header">
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-start has-content" aria-labelledby="dropdownMenuButton1">
                        <li>
                            <h6>الرسائل</h6>
                        </li>
                        <li>
                            <div class="noti-item w-full wg-user active">
                                <div class="image">
                                    <img src="https://themesflat.co/html/remos/images/avatar/user-1.png" alt="">
                                </div>
                                <div class="flex-grow">
                ...
                <div class="dropdown">
                    <button class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton3"
                        ...
                        <span class="header-user wg-user">
                            <span class="image">
                                <img src="{{ storage_public_url($profileData->image) }}" alt="">
                            </span>
                            <span class="flex flex-column">
                                <span class="body-title">{{ $profileData->name }}</span>
                                <span class="text-tiny">مشرف</span>
                            </span>
                        </span>
                    </button>
                    <ul class="dropdown-menu dropdown-menu-start has-content" aria-labelledby="dropdownMenuButton3">
                        <li>
                            <a href="{{ route('dashboard.profile') }}" class="user-item">
                                <div class="icon">
                                ...
                                <div class="body-title-2">حسابي</div>
                            </a>
                        </li>
                        <li>
                            <a href="setting.html" class="user-item">
                                ...
                                <div class="body-title-2">الإعدادات</div>
                            </a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="{{ route('dashboard.logout') }}" class="user-item">
                                <div class="icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24"
                                        height="24" color="#ffffff" fill="none">
                                        <path
                                ...
                                <div class="body-title-2">تسجيل خروج</div>
                            </a>
                        </li>
                    </ul>
                </div>

...
@section('content')
    <div class="main-content-inner">
        <div class="main-content-wrap">
            ...
            <div class="wg-box">
                <form action="{{ route('dashboard.admins.update', $admin->id) }}" method="POST" id="editAdminForm">
                    ...
                    <div class="row">
                        <div class="col-6">
                            <fieldset class="password mb-24">
                                <div class="body-title mb-5">كلمة المرور القديمة </div>
                    ...
                    <div class="row">
                        <div class="col-6">
                            <fieldset class="password mb-24">
                                <div class="body-title mb-5">كلمة المرور الجديدة </div>
                                <div class="password-box">
                                    <input class="password-input" type="password" placeholder="اكتب كلمة المرور هنا ..."
                                        name="new_password">
                                    <span class="show-pass">
